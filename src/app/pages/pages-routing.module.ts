...
const indentModule = () => import('../indent/indent.module').then(x => x.IndentModule);
...
const requisitionModule = () => import('../Requisition/Requisition.module').then(x => x.RequisitionModule);
const routes: Routes = [{
  path: '',
  ...
  children: [
    ...
    {
      path: 'indent',loadChildren: indentModule
    },
    {
