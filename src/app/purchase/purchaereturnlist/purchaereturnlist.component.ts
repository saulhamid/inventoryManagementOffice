...
@Component({
  selector: 'ngx-purchaereturnlist',
  templateUrl: './purchaereturnlist.component.html'
})
export class PurchaereturnlistComponent implements OnInit {
...
this.Total=0;
  ...
  getPurchase(){
    ...
    debugger
      this.purchaseorderService.getAllpurchaseReturn().subscribe(result => {
