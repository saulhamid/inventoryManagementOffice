...
@Component({
  selector: 'ngx-stocktransferapproved',
  templateUrl: './stocktransferapproved.component.html',
  styleUrls: ['./stocktransferapproved.component.scss']
})
export class stocktransferapprovedComponent implements OnInit {
...
dtTrigger: Subject<any> = new Subject();
  ...
  getstocktransfer(){
      this.stocktransferService.getSelectAllApprovedAll().subscribe(result => {
          console.log(result);
      ...
      onApproved(requisitionmaster,ref) {
           this.stocktransferService.approved(requisitionmaster).subscribe(result => {
