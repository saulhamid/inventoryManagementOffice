...
@Component({
  selector: 'ngx-stocktransferlistnew',
  templateUrl: './stocktransferlistnew.component.html',
  styleUrls: ['./stocktransferlistnew.component.scss']
})
export class stocktransferlistnewComponent implements OnInit {
...
getFromBranchByCompany(companyId){
  ...
  this.FromSubbranchCompany = null;
this.FrombranchCompany= this.branchall.filter(e=>e.companyId==companyId && e.isSubBranch!=true ) as Branch[];
this.FromSubbranchCompany = this.branchall.filter(e=>e.companyId==companyId && e.isSubBranch==true) as Branch[];
this.stocktransfer.ToCompanyId=0;
this.stocktransfer.ToBranchId=0;
}
getTOBranchByCompany(companyId){
  this.TobranchCompany= null;
  this.TobranchCompany= this.branchall.filter(e=>e.companyId==companyId && e.isSubBranch!=true && e.id!= this.stocktransfer.FromBranchId)as Branch[];
  this.ToSubbranchCompany= this.branchall.filter(e=>e.companyId==companyId && e.isSubBranch==true && e.id!= this.stocktransfer.FromBranchId)as Branch[];
  }
onSubmit(){
  debugger
...
btnaddProduct(){
 ...
 var data= this.productall.filter(e=>e.productCode==this.productId)[0]
  ...
  this.StockQty=0;
  this.qty=0;
  console.log("dddd",this.stocktransferdetail)
}
...
getproduct(BranchId){
  ...
  //
  this.TobranchCompany= this.branchall.filter(e=> e.isSubBranch!=true && e.id!= this.stocktransfer.FromBranchId)as Branch[];
  this.ToSubbranchCompany= this.branchall.filter(e=> e.isSubBranch==true && e.id!= this.stocktransfer.FromBranchId)as Branch[];
    //        
  debugger;
