...
@Component({
  selector: 'ngx-stockIssuereport',
  templateUrl: './stockIssuereport.component.html',
  styleUrls: ['./stockIssuereport.component.scss']
})
...
getProduct(){
    ...
    filtersubmit(){
      ...
      var date= this.stockfilter.expireDate == null ? '' : this.stockfilter.expireDate.toLocaleDateString();
        this.productService.getAllStockIssueFilter(this.stockfilter.productName, this.stockfilter.categoryID,this.stockfilter.subCategoryId,this.stockfilter.uomId,date).subscribe(result => {
